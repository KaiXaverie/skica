...
<html lang="en">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul>
                <li class="nav-item active">
                    <a id="coloring" href="management.php"> Management </a>
                </li>
            </ul>
            <ul>
                <li class="nav-item active">
        ...
        <div id="jumbotron" class="jumbotron text-center text-white" style="background-image: url(/back.jpg)">
            ...
            <h1 class="display-4 mt-5">Welcome to gallery, <?php echo $_SESSION['username']; ?>!</h1>
            <p class="lead">Upload photos now!<br></p>
            <hr class="my-4">
