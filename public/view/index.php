...
<html lang="en">
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
          <a class="navbar-brand mb-0 h1" href="/gallery.php"><svg width="1.0625em" height="1em" viewBox="0 0 17 16" class="bi bi-image-alt" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <div id="jumbotron" class="jumbotron text-center text-white" style="background-image: url(/back.jpg)">
              ...
              <p class="lead">Upload photos now!<br><a href="/login.php">Log in</a></p>
              <hr class="my-4">
              <p>Don't have an account? <br>Join us <a href="/registration.php">here</a></p>

          </div>

          <table class="table table-striped table-light" id="tables">
              <thead>
                  <tr>
                      <th scope="col">#</th>
